                  ...
                  child: Row(
                    children: <Widget>[
                      ...
                      DropdownButton<bool>(
                        ...
                        hint: Text("Select"),
                        items: [true, false].map((bool selectedValue) {
                        ...
                        child: Row(
                          children: <Widget>[
                            ...
                            DropdownButton<String>(
                              ...
                              items:
                                  ["Male", "Female"].map((String selectedSex) {
            ...
            Flexible(
              ...
              child: Container(
                ...
                child: Form(
                  ...
                  child: Theme(
                    data:
                        ThemeData(primaryColor: Color.fromRGBO(35, 71, 162, 1)),
                    child: Stepper(
                      steps: steps,
